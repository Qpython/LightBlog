...
<html lang="en">
  <head>
    ...
    <link href="/blog/styles/style/default/static_file/css/blog.css" rel="stylesheet">
          ...
          <h3>Rregister Form</h3><br>
                       ...
                       %end
                        ...
                        <form action="register" method="POST">                       
                            ...
                            <input name="username" type="text" class="span5"/>
                            </div>
                            ...
                            <input name="password2" type="password" class="span5"/>
                            </div>
                            
                             <div>
                            <label>email</label>
                            <input name="email" type="text" class="span5"/>
                            </div>
